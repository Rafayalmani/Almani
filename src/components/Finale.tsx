...
const Finale = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/Rafayalmani", label: "GitHub" },
    {
      icon: Linkedin,
      href: "https://www.linkedin.com/in/rafay-almani-3668b8268/",
      label: "LinkedIn",
    },
    {
      icon: Mail,
    ...
    {
      icon: InstagramIcon,
      href: "https://www.instagram.com/nvm_almani/",
      label: "Instagram",
    },
  ];
