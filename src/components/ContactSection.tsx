...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const phoneNumber = "+923155089965";
        ...
        <div className="space-y-8 md:space-y-10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 border border-foreground/10 bg-white/50 hover:border-black transition-colors duration-300">
              ...
              <div>
                ...
                <p className="font-mono text-sm">+92 3155089965</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              {[
                { Icon: Github, href: "https://github.com/Rafayalmani" },
                { Icon: Linkedin, href: "https://www.linkedin.com/in/rafay-almani-3668b8268" },
                { Icon: InstagramIcon, href: "https://www.instagram.com/nvm_almani" },
              ].map(({ Icon, href }, i) => (
                <a
                  key={i}
                  href={href}
